  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #f5f5f5;">
    ...
    const modalContent = `
      <div style="max-height: 60vh; overflow-y: auto; padding-right: 1rem;">
        ...
        <div style="margin-top: 1.5rem; display: flex; gap: 1rem; flex-wrap: wrap;">
          ...
          <button class="btn btn-outline" id="btn-download-html" style="flex: 1; min-width: 200px;">
            <i data-lucide="download"></i> Descargar archivo HTML
          </button>
        </div>
    ...
    setTimeout(() => {
      ...
      document.getElementById('btn-download-html')?.addEventListener('click', () => {
        ...
        a.href = url;
        a.download = `PSR_Email_${project.name.replace(/[^a-z0-9]/gi, '_')}_Week${d.week || 'Current'}.html`;
        document.body.appendChild(a);
        a.click();
        document.body.removeChild(a);
        URL.revokeObjectURL(url);
        App.toast('Archivo HTML descargado. Abre el archivo y copia el contenido a tu email.', 'success');
      });
