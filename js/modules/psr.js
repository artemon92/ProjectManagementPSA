...
<body style="margin: 0; padding: 0; font-family: 'Segoe UI', Arial, sans-serif; background-color: #f5f5f5;">
  <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #f5f5f5;">
    ...
    // Navigate to email section and populate
    App.navigateTo('email');
    
    setTimeout(() => {
      document.getElementById('email-subject').value = `[PSA BDP] Weekly Project Status - ${project.name} - Week ${d.week || 'Current'}`;
      ...
      App.toast('Email generado con datos del PSR actual', 'success');
    }, 100);
  }
};
